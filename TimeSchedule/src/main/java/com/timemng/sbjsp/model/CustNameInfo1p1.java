...
// CustNameInfo1p1 - model class ( the class representing the customer ID, first name, last name from the customer table )
public class CustNameInfo1p1 extends PersonInfo1p1 {
