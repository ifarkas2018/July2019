...
import com.timemng.sbjsp.model.MessageInfo1p1; // MessageInfo - model class ( the class representing the data of the record in the message table )
...
public class MessageMapper1p1 implements RowMapper<MessageInfo1p1> {
	...
	// SQL_INSERT is a SQL query used to insert a new message in the message table
	public static String SQL_INSERT // 
	= "insert into message(emp_id, message) values (";  
	...
	public static void resetSQL_INSERT() {
		SQL_INSERT = "insert into message(emp_id, message) values (";
	}
